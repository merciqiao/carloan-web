    ...
    <!--新增按钮-->
        ...
        <div style=" width:45%;float:right;">
           ...
           <el-col :span="1" class="grid">
            ...
            <el-table :data="roleUserList"  @selection-change="roleuserSelectChange"  border style="width: 100%" stripe ref="roleUserList" tooltip-effect="dark">
            <!--勾选框-->
            <el-table-column type="selection" width="55">
            </el-table-column>
            <!--索引-->
        ...
        <el-pagination         
         @current-change="getRoleUserList"
         :current-page="roleusercurrentPage"         
         :page-size="pageSize"
         layout="total, prev, pager, next"
         :total="roleusercount" >
        </el-pagination>  
