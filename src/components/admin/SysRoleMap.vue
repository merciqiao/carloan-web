<template>   
        <div style=" width:50%;">
           <h5> 权限管理</h5> 
                  角色编码： <el-input v-model="s_rolecode"  placeholder="角色编码" style="width:200px; heght:30px;"></el-input>
              <br>
              映射角色编码：  <el-input v-model="s_maprolecode"   placeholder="映射角色编码" style="width:200px; heght:30px;"></el-input>
             <br>
    ...
    <!--新增按钮-->
        ...
        <!--表格数据及操作-->
        <el-table :data="tableData" border style="width: 100%" stripe ref="multipleTable" tooltip-effect="dark" @selection-change="selectChange">
            <!--勾选框-->
        ...
        { 
          var _this=this;                 
            let param = Object.assign({}, {currentPage:val,pageSize:10,roleCode:this.s_rolecode,mappingRoleCode:this.s_maprolecode});
            this.$ajax({
                method: "post",
