    ...
    <div class='bg' :style='bg'>
        <div class='login_input_container'>
            ...
            <div class="login_input">
                帐号：
                <el-input placeholder="请输入帐号" prefix-icon="el-icon-service" v-model="loginName">
                </el-input>
                密码：
                <el-input type="password" placeholder="请输入密码" prefix-icon="el-icon-view" v-model="password">
                </el-input>
            </div>
            <div class="login_btn">
    ...
    methods: {
        login() {
            this.$store.dispatch('login', {
                ...
                //动态设置路由
                this.$store.dispatch('add_Routes',this.sysMenuList);
                //动态设置菜单
                this.$store.dispatch('add_Menus',this.sysMenuList);
