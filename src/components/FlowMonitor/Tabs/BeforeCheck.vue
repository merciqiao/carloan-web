<template>
    <div class="p20">
        ...
        <el-row class="mt20">
            ...
            <el-col :span="4"><el-input size="mini" v-model="ACTIVITYNAME"></el-input></el-col>
        </el-row>
        <el-row class="mt20">
       ...
       <div class="table"> <!-- 页面表格begin -->
            <el-table
                :data="beforeCheckMonitor.slice((currentPage-1)*pageSize,currentPage*pageSize)"
                border
                style="width: 100%"
            >
                <el-table-column
            ...
            <div class="page_container">
                <el-pagination
                    ...
                    :total="beforeCheckMonitor.length">
                </el-pagination>
            </div>
        </div><!-- 页面表格end -->
    </div>
...
export default {
    ...
    methods: {
        ...
        handleQuery() {
            ...
            this.$store.dispatch('getBeforeMonitor',queryObj);
        },
        resetQuery() {
            this.bIZINFNO = "";
            this.uSERNAME = "";
    ...
    computed: mapState({
        ...
        beforeCheckMonitor: state => state.myTask.beforeCheck_monitor,
    ...
    mounted() {
        ...
        //获取待审核监控
        this.$store.dispatch('getBeforeMonitor',{});
        //获取区域
