...
export default {
    ...
    methods: {
        handleClick(row) {
            this.$router.push({ name:'PriceDetail', query: {processId:row.tASKID,carInfoId: row.bIZINFID,order_number:row.bIZINFNO, status:1, actName: row.cURACTNAME,bizType: row.bIZTYPE}});
            //保存定价结论的参数
